...
export default function Grade() {
    ...
    // Per-essay numeric inputs + feedback, seeded from the server detail.
    ...
    // Re-seed drafts whenever the server detail changes (after a save the
    // page reloads with recomputed scoring).
    useEffect(() => {
    ...
    function onSaveEssay(item: Item) {
        ...
        router.post(
            `/teacher/scores/${detail.id}/grade`,
    ...
    return (
        <TeacherShell>
            ...
            <header className="teacher-page-header">
                ...
                <Link className="ghost-button" href="/teacher/scores">
                ...
                <ol className="grading-list">
                    {detail.items.map((item) => (
                        <li key={item.question.id} className="grading-item">
                            ...
                            {/* Mark scheme / model answer for essays. Auto-graded
                                questions show their explanation as feedback too. */}
